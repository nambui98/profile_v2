    ...
    <div className="App">
      <div className="flex h-screen w-screen items-center justify-center">
        <div className="flex w-full items-start justify-center" style={{ height: "600px" }}>
          ...
          <div className="rounded-3xl w-4/12 md:flex sm:hidden smx:hidden h-full mx-4 bg-app shadow-3xl dark:shadow-3xl-dark flex items-center flex-col py-10 px-6">
